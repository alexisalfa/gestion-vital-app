...
function App() {
  ...
  const { API_BASE_URL, MASTER_LICENSE_KEY, selectedLanguage, currencySymbol, dateFormat, selectedCountry, licenseKey, isLicenseValid, setSelectedLanguage, setCurrencySymbol, setDateFormat, setSelectedCountry, setLicenseKey, saveSettings, getDateFormatOptions } = useGlobal();
