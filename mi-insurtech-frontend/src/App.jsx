  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen flex bg-slate-50 font-sans">
        ...
        {/* --- PANEL IZQUIERDO (MÍSTICA Y MARCA) --- */}
        {/* Se oculta en celulares, se muestra en pantallas grandes */}
        <div className="hidden lg:flex lg:w-1/2 bg-blue-700 relative overflow-hidden items-center justify-center">
          {/* Fondo con gradiente elegante */}
          <div className="absolute inset-0 bg-gradient-to-br from-blue-800 via-blue-700 to-indigo-900"></div>
          
          {/* Elementos decorativos (Círculos abstractos) */}
          <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-white opacity-5 rounded-full blur-3xl"></div>
          <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-indigo-400 opacity-20 rounded-full blur-3xl"></div>
          
          <div className="relative z-10 text-white p-12 max-w-lg text-center flex flex-col items-center">
            <div className="bg-white/10 p-4 rounded-2xl backdrop-blur-md mb-8 shadow-2xl border border-white/20">
              <ShieldAlert className="h-20 w-20 text-blue-100" />
            </div>
            <h1 className="text-4xl font-black mb-6 tracking-tight">Gestión Vital 360°</h1>
            <p className="text-blue-100 text-lg leading-relaxed font-medium">
              El ecosistema Insurtech diseñado para automatizar tu agencia, proteger tu cartera y multiplicar tus comisiones.
            </p>
          </div>
        </div>

        {/* --- PANEL DERECHO (FORMULARIOS Y GOOGLE) --- */}
        <div className="w-full lg:w-1/2 flex flex-col justify-center p-6 sm:p-12 lg:p-20 bg-white shadow-[-20px_0_40px_-15px_rgba(0,0,0,0.1)] relative z-10">
          <div className="max-w-md w-full mx-auto space-y-8">
            ...
            <button 
              type="button"
              className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 text-slate-700 px-4 py-3.5 rounded-xl font-bold hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm"
            ...
            <div className="relative flex items-center">
              ...
              <span className="flex-shrink-0 mx-4 text-slate-400 text-sm font-medium">O ingresa con tu correo</span>
              <div className="flex-grow border-t border-slate-200"></div>
            </div>

            {/* TUS FORMULARIOS INTACTOS */}
            ...
            <div className="text-center pt-2">
              <p className="text-slate-600 text-sm font-medium">
                ...
                <Button variant="link" onClick={() => setShowRegisterForm(!showRegisterForm)} className="ml-2 text-indigo-600 hover:text-indigo-800 font-bold p-0 text-sm">
